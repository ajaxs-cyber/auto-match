...
const KEYWORD_PATTERNS = [
  ...
  { keywords: ['作品', '作品集', 'portfolio', '设计', '创意', '艺术', '摄影', '展示', 'showcase', 'gallery'], suggestion: '作品集/展示站', template: 'card_grid', modules: ['header', 'hero', 'gallery', 'features', 'contact', 'footer'], colorScheme: { primary: '#0f0f0f', accent: '#ec4899' } },
  { keywords: ['餐饮', '餐厅', '咖啡', 'cafe', 'restaurant', '美食', '菜单', '食品', '茶', '酒吧', '烘焙', 'food'], suggestion: '餐饮/美食站', template: 'story_flow', modules: ['header', 'hero', 'features', 'gallery', 'pricing', 'contact', 'footer'], colorScheme: { primary: '#78350f', accent: '#f97316' } },
  { keywords: ['教育', '课程', 'edu', '学习', '培训', '学校', '教学', '网课', '在线教育', '学生', '老师', '课堂', 'course'], suggestion: '教育/课程站', template: 'story_flow', modules: ['header', 'hero', 'features', 'pricing', 'team', 'contact', 'footer'], colorScheme: { primary: '#065f46', accent: '#10b981' } },
  { keywords: ['个人', '个人主页', '自我介绍', '简历', 'about', 'profile', '名片', '介绍', 'resume', 'cv'], suggestion: '个人名片/简历', template: 'minimal_action', modules: ['header', 'hero', 'features', 'gallery', 'contact', 'footer'], colorScheme: { primary: '#1e293b', accent: '#64748b' } },
  { keywords: ['科技', 'SaaS', '互联网', 'tech', '软件', 'app', 'startup', '科技公司', '数码', 'IT', '智能', '创业'], suggestion: '科技/SaaS站', template: 'minimal_action', modules: ['header', 'hero', 'features', 'pricing', 'testimonials', 'contact', 'footer'], colorScheme: { primary: '#0f172a', accent: '#06b6d4' } },
  { keywords: ['房地产', '地产', '楼盘', '房产', '房屋', '租房', '买房', '物业', '公寓', '别墅', '中介', 'property'], suggestion: '房地产/房产站', template: 'card_grid', modules: ['header', 'hero', 'features', 'gallery', 'pricing', 'contact', 'footer'], colorScheme: { primary: '#451a03', accent: '#d97706' } },
  { keywords: ['医疗', '医院', '诊所', '医生', '健康', '医美', 'health', 'medical', '牙科', '中医', '护理', 'clinic'], suggestion: '医疗/健康站', template: 'story_flow', modules: ['header', 'hero', 'features', 'team', 'testimonials', 'contact', 'footer'], colorScheme: { primary: '#0c4a6e', accent: '#0ea5e9' } },
